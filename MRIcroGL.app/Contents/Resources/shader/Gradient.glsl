//pref
ambient|float|0.0|1.0|2|Illuminate surface regardless of lighting
diffuse|float|0.0|0.0|2|Illuminate surface based on light position
specular|float|0.0|0.0|2|Glint from shiny surfaces
...
void main() {
	...
	for(int i = 0; i < loops; i++) {
		...
		colorSample.rgb = abs(colorSample.rgb*2.0 - 1.0);
