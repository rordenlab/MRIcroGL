...
uniform float clippingRadius = 0.5;
void main() {
	...
	vec3 volCenter = vec3(0.5, 0.5, 0.5);
	...
	while (samplePos.a <= len) {
		...
		if ((length(samplePos.rgb-volCenter) < clippingRadius) &&(colorSample.a > 0.01)) {
