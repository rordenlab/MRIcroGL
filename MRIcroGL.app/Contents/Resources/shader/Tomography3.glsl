...
edgeHardness|float|0.01|0.3|0.99
...
uniform float edgeHardness = 0.5;
...
void main() {
	...
	float bias = ((1.0/edgeHardness) - 2.0);
	while (samplePos.a <= len) {
		...
		if (colorSample.a > 0.0) {
			...
			float y = colorSample.r * 0.2126 + colorSample.g * 0.7152 + colorSample.b * 0.0722;
			float thresh = y / ((bias*(1.0 - y))+1.0);
			if (gradSample.a > thresh) colorSample.a *= mix(0.0, 1.0, (gradSample.a-thresh)/(1.0-thresh) );	
