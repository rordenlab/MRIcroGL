...
g++ -O3 -dead_strip -I. main_console.cpp nii_foreign.cpp nii_dicom.cpp nifti1_io_core.cpp nii_ortho.cpp nii_dicom_batch.cpp jpg_0XC3.cpp ujpeg.cpp -o dcm2niix -DmyDisableOpenJPEG -DmyDisableMiniZ -I~/cloudflarez ~/cloudflarez/libz.a
strip ./dcm2niix
